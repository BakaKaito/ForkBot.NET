...
namespace SysBot.Pokemon
{
    public class DiscordSettings
    {
        ...
        [Category(Whitelists), Description("Users with this role are allowed to enter the SpecialRequest queue.")]
        public string RoleCanSpecialRequest { get; set; } = DefaultDisable;
